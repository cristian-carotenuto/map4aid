...
> **\#5: Prenotazione ritiro beni di prima necessità**
...
<th colspan="4" rowspan="3"><p><strong>Identificativo</strong></p>
<p><em>U.C. -9</em></p></th>
<th rowspan="3"><em><strong>Storico attività e reportistica</strong></em></th>
<th colspan="2"><em>Data</em></th>
...
<th colspan="4" rowspan="3"><p><strong>Identificativo</strong></p>
<p><em>UC#11</em></p></th>
<th rowspan="3"><em>Filtraggio catalogo e collegamento ai punti di distribuzione</em></th>
<th colspan="2"><em>Data</em></th>
<th><em>21/11/2025</em></th>
</tr>
<tr class="odd">
<th><em>Vers.</em></th>
<th colspan="2"><em>0.00.000</em></th>
...
<tr class="header">
<th><em>Autore</em></th>
<th colspan="2"><em>Emilio Maione</em></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td colspan="4"><strong>Descrizione</strong></td>
<td colspan="4"><em>L’utente visualizza il catalogo globale dei beni, applica filtri gerarchici (macrocategoria, sottocategoria, bene specifico) e la mappa viene aggiornata mostrando solo i punti di distribuzione che possiedono il bene selezionato.</em></td>
</tr>
<tr class="even">
<td colspan="4"><strong>Attore Principale</strong></td>
<td colspan="4"><p><strong>Utente (beneficiario o donatore)</strong></p>
<p>Interessato a cercare prodotti disponibili nei punti di distribuzione.</p></td>
</tr>
<tr class="odd">
<td colspan="4"><strong>Attori secondari</strong></td>
<td colspan="4"><p><strong>Sistema / Enti erogatori</strong></p>
<p>Il sistema fornisce i dati del catalogo e aggiorna la mappa in base alla disponibilità fornita dagli enti.</p></td>
</tr>
<tr class="even">
<td colspan="4"><strong>Entry Condition</strong></td>
...
<tr class="even">
<td>1</td>
<td colspan="2"><blockquote><p>Utente:</p></blockquote></td>
<td colspan="5">Accede alla sezione “Catalogo”.</td>
</tr>
<tr class="odd">
<td>2</td>
<td colspan="2"><blockquote><p>Sistema:</p></blockquote></td>
<td colspan="5"><blockquote><p>Mostra il catalogo con le categorie, sottocategorie e i filtri disponibili.</p></blockquote></td>
</tr>
<tr class="even">
<td>3</td>
<td colspan="2"><blockquote><p>Utente:</p></blockquote></td>
<td colspan="5">Seleziona una <strong>macrocategoria</strong> (es. Alimentari).</td>
</tr>
<tr class="odd">
<td>4</td>
<td colspan="2"><blockquote><p>Utente:</p></blockquote></td>
<td colspan="5">Seleziona una <strong>sottocategoria</strong> (es. Pane e derivati).</td>
</tr>
<tr class="even">
<td>5</td>
<td colspan="2"><blockquote><p>Utente:</p></blockquote></td>
<td colspan="5">Se necessario, seleziona un <strong>bene specifico</strong> (es. Pane senza glutine).</td>
</tr>
<tr class="odd">
<td>6</td>
<td colspan="2"><blockquote><p>Sistema:</p></blockquote></td>
<td colspan="5"><em>Filtra automaticamente il catalogo e invia alla mappa la richiesta di aggiornamento in base al bene selezionato.</em></td>
</tr>
<tr class="even">
<td>7</td>
<td colspan="2"><blockquote><p>Sistema:</p></blockquote></td>
<td colspan="5"><em>Aggiorna la mappa mostrando solo i punti di distribuzione che possiedono il bene selezionato.</em></td>
</tr>
<tr class="odd">
<td colspan="8"><strong>I Scenario/Flusso di eventi di ERRORE:</strong> Nessun punto disponibile</td>
</tr>
<tr class="even">
<td colspan="2"><strong>6.1</strong></td>
<td colspan="2"><strong>Sistema:</strong></td>
<td colspan="4">Mostra un messaggio: “Nessun punto di distribuzione possiede questo bene al momento”.</td>
</tr>
<tr class="odd">
<td colspan="8"><strong>II Scenario/Flusso di eventi di ERRORE:</strong> Catalogo non disponibile</td>
</tr>
<tr class="even">
<td colspan="2"><strong>2.1</strong></td>
<td colspan="2"><strong>Sistema:</strong></td>
<td colspan="4">Errore nel caricamento del catalogo. Mostra un messaggio di malfunzionamento.</td>
</tr>
<tr class="odd">
<td colspan="8"><strong>Note</strong></td>
</tr>
<tr class="even">
<td colspan="4"><strong>1</strong></td>
<td colspan="4">Il filtraggio è gerarchico e dinamico: ogni selezione aggiorna la lista delle scelte disponibili.</td>
</tr>
</tbody>
</table>
